...
/*> ../assets/easy-facebook/easy-facebook.js */
/*> ../assets/js-utils/math-rand.js */
/*> ../assets/facedetection/facedetection.js */
	...
	savePhoto: function(url,autoface){
		...
		$.get('save-image.php?file='+url, function(img){
			return function(){
				...
				$('<img src="images/'+img.substr(img.lastIndexOf('/')+1)+'">').prependTo(self.$app)
				.wrap('<div class="fb-pic faces">')
				.after('<div class="frame"></div>'+(rand(0, 1)==1 ? '<div class="deer"></div>' : '')+(rand(0, 1)==1 ? '<div class="tinsel"></div>' : '')+(rand(0, 1)==1 ? '<div class="tree"></div>' : ''));
